...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 0d9a2591-8aa5-47d4-ba72-8e5266005798
```

> `0d9a2591-8aa5-47d4-ba72-8e5266005798` is the password of the certificate, you can change it to any password you want.
